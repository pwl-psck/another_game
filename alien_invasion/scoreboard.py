...
class Scoreboard():
	...
	def __init__(self, ai_settings, screen, stats):
		""" Inicjacja atrybutów dotyczących punktacji."""
		self.screen = screen
		...
		#Przygotowanie pozcątkowych obrazów z punktacją.
		self.prep_score()
	...
	def prep_high_score(self):
		...
		self.text_color, self.ai_settings.bg_color)
		# Wyświetlenie najlepszego wyniku w grze na środku ekranu, przy
		# górnej krawędzi.
	...
	def show_score(self):
		"""Wyświetlenie punktacji i poziomu gry na ekranie"""
	...
	def prep_level(self):
		...
		#Numer poziomu jest wyświetlony pod aktualną punktacją.
